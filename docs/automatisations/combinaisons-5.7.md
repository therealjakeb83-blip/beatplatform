...
- [ ] **3. Combo non configurée** (recette combo désactivée) → **règle révisée le 2026-07-16** (voir Notes d'implémentation) : l'achat gagne seul, bienvenue abo silencieuse — à retester, le comportement "2 mails séparés" validé plus tôt aujourd'hui ne s'applique plus.
