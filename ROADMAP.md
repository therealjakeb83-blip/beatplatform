...
| 5.2 | Les workflows en isolation (contenu + déclencheur) — **construits un par un** : 7 workflows retenus (Follow-up favori annulé le 2026-07-10, voir 5.6h), tous codés. Validés en test réel : Bienvenue abonnement, Abonnement en attente, Churn message perso, Remerciement achat 1er achat. Codés mais pas encore testés : Remerciement 2e/3e/4e+, Bienvenue perso, Relance inactivité, Follow-up free download | 🔄 |
