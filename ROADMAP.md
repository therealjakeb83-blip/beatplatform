...
> Dernière mise à jour : 2026-07-03 — Marketing (11d Phase 4) : 4.4 (éditeur de templates) et 4.6 (désinscription) validés. Vue Newsletter CRM construite. Reste 4.5 (domaine d'envoi) et 4.8 (tests formels) avant la Phase 5 (Automatisations).
