...
| 5.6c | Churn message perso | Annulation réelle — distinct de la confirmation robotique d'annulation (Phase 6 Transactionnels) | 🔄 *(codé 2026-07-08, à tester)* |
...
| 5.2 | Les 8 workflows en isolation (contenu + déclencheur) — **construits un par un** : 2/8 validés (Bienvenue abonnement, Abonnement en attente) | 🔄 |
