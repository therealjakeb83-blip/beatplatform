...
#### Checklist tests Étape 8b (suite) — Gate d'accès dashboard
...
- [ ] **T20** — La boutique publique `/{slug}` d'un beatmaker sans abonnement ni exemption affiche "Cette boutique n'est pas encore active" au lieu du catalogue (visite en navigation privée, sans être connecté)
