...
export default function RenvoyerLogPlateformeButton({ logId }: { logId: string }) {
  ...
  async function handleClick(e: React.MouseEvent) {
    ...
    setState('sending')
    try {
      const res = await fetch(`/api/admin/mails-plateforme/logs/${logId}/renvoyer`, { method: 'POST' })
