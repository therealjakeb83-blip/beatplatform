...
const SOURCE_LABELS: Record<string, string> = {
  instagram: 'Instagram', youtube: 'YouTube', tiktok: 'TikTok', google: 'Google', newsletter: 'Newsletter', direct: 'Direct', autre: 'Autre',
}
...
const SOURCE_LABELS_SMALL: Record<string, string> = { instagram: 'IG', youtube: 'YT', tiktok: 'TT', google: 'Google', newsletter: 'NL', direct: 'Direct', autre: 'Autre' }
