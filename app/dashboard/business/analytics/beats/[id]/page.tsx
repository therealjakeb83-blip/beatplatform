...
const SOURCE_LABELS: Record<string, string> = {
  instagram: 'Instagram', youtube: 'YouTube', tiktok: 'TikTok', google: 'Google', direct: 'Direct', autre: 'Autre',
}
...
const SOURCE_LABELS_SMALL: Record<string, string> = { instagram: 'IG', youtube: 'YT', tiktok: 'TT', google: 'Google', direct: 'Direct', autre: 'Autre' }
