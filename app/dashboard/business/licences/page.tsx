...
const LICENCES_DEFAUT = [
  { ordre: 1, nom: 'MP3',       prix: 25,  modele: 'mp3',       inclut_mp3: true, inclut_wav: false, inclut_stems: false, est_exclusive: false, streams_limite: 50000,  vues_video_limite: 200000, clips_video_limite: 1, radio_tv_limite: 1 },
  { ordre: 2, nom: 'WAV',       prix: 45,  modele: 'wav',       inclut_mp3: true, inclut_wav: true,  inclut_stems: false, est_exclusive: false, streams_limite: 100000, vues_video_limite: 500000, clips_video_limite: 2, radio_tv_limite: 2 },
  { ordre: 3, nom: 'STEMS',     prix: 75,  modele: 'stems',     inclut_mp3: true, inclut_wav: true,  inclut_stems: true,  est_exclusive: false, streams_limite: null,   vues_video_limite: null,   clips_video_limite: null, radio_tv_limite: null },
