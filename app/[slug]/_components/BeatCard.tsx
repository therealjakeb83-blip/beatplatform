      ...
      >
        ...
        {estVerrouille ? (
          ...
          <>
            ...
            {/* Mobile : aucun bouton visible par défaut, tap sur la cover lance
                la lecture — l'overlay ne montre que le bouton achat, l'arrêt
                se fait depuis le player du bas. */}
            ...
            {moinsChere && (
              <div className="shop-beat-mobile-ctrls">
                <button onClick={handleMobileCart} className="shop-beat-mobile-cart" aria-label="Acheter">
                  <svg width="19" height="19" viewBox="0 0 24 24" fill="none"><path d="M6 7h12l-1 13H7L6 7z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" /><path d="M9 7a3 3 0 016 0" stroke="currentColor" strokeWidth="2" /></svg>
                </button>
              </div>
            )}
          </>
