...
// ============================================================
// Modèle par défaut — licence exclusive
// ============================================================
// Basé sur Template_licence_EXCLUSIVE_SaaS_FINAL.docx (rédigé par Jake).
// Texte séparé et indépendant des deux autres modèles. Différences
// notables par rapport au standard/illimité, toutes en texte fixe (aucune
// nouvelle variable) : plusieurs "Nouvelles Œuvres" autorisées (pas une
// seule), le Concédant s'interdit toute nouvelle licence sur l'Œuvre après
// la vente, le Licencié devient titulaire du master de ses Nouvelles
// Œuvres, le Content ID est autorisé (inversé par rapport aux 2 autres
// licences), durée illimitée au lieu de 10 ans.
//
// Implication fonctionnelle réelle (pas juste textuelle, décidée par
// Jake) : après une vente Exclusive, le beat doit être retiré de la vente
// — voir le passage de beats.statut à 'vendu' dans finaliserCommandePayee
// (lib/webhook-paiement.ts), colonne prévue depuis le schéma d'origine
// mais jamais branchée jusqu'ici.
export function texteTemplateExclusive(): string {
  return `CONTRAT DE LICENCE EXCLUSIVE
...
Le présent contrat a pour objet l'octroi d'une licence exclusive d'exploitation d'une composition musicale proposée par le Concédant, identifiée sous le nom {{titre_beat}}, en contrepartie du montant effectivement payé par le Licencié lors de la commande, soit {{prix_paye}}, après application éventuelle de toute remise, promotion, réduction, avoir, avantage ou offre commerciale applicable au moment de l'achat.

Ce contrat est délivré uniquement pour l'utilisation de l'Œuvre par le Licencié conformément à l'ensemble des conditions énoncées dans le présent document.

La présente Licence autorise le Licencié à incorporer l'Œuvre dans une ou plusieurs nouvelles créations musicales, ci-après dénommées individuellement ou collectivement « Nouvelle(s) Œuvre(s) ».
...
Le Licencié est autorisé à transmettre les fichiers de l'Œuvre uniquement aux personnes participant directement à la création d'une ou plusieurs Nouvelles Œuvres, notamment un ingénieur du son, musicien, réalisateur artistique, studio d'enregistrement ou autre prestataire technique.
Ces personnes ne bénéficient d'aucun droit personnel d'exploitation sur l'Œuvre et ne peuvent utiliser les fichiers dans un autre projet.
Le Licencié demeure responsable du respect de la présente Licence par toute personne à laquelle il transmet les fichiers.
...
La présente Licence est concédée à titre EXCLUSIF. Les droits portant directement sur l'Œuvre instrumentale sont personnels au Licencié et ne peuvent être transférés ou sous-licenciés à un tiers, sauf disposition expressément contraire du présent Contrat.
Les droits accordés au Licencié sur l'Œuvre sont d'interprétation stricte. Tous les droits qui ne sont pas expressément mentionnés dans la présente Licence demeurent réservés au Concédant.
À compter de la prise d'effet de la présente Licence Exclusive, le Concédant s'interdit de vendre, concéder ou accorder à tout tiers une nouvelle licence d'exploitation portant sur la même Œuvre. Toute licence non-exclusive régulièrement accordée avant cette date demeure toutefois pleinement valable jusqu'à son terme et selon ses propres conditions, sans être résiliée, réduite ou affectée par la présente Licence Exclusive. Le Licencié reconnaît l'existence éventuelle de telles licences antérieures et s'interdit de contester, bloquer, faire supprimer ou autrement entraver toute exploitation réalisée conformément à celles-ci.

4.2. Création d'une ou plusieurs Nouvelles Œuvres

Le Licencié dispose du droit exclusif d'utiliser tout ou partie de l'Œuvre afin de créer une ou plusieurs Nouvelles Œuvres.
Dans ce cadre, le Licencié est notamment autorisé à :
• ajouter des paroles et des prestations vocales ;
• ajouter ses propres éléments musicaux ;
• modifier la structure et l'arrangement de l'Œuvre ;
...
• modifier son tempo ;
• modifier sa tonalité ou sa hauteur ;
• couper, réorganiser ou répéter certaines parties de l'Œuvre dans le but de créer une ou plusieurs Nouvelles Œuvres.
Ces modifications ne confèrent au Licencié aucun droit de propriété sur l'Œuvre instrumentale originale.

4.3. Exploitation des Nouvelles Œuvres

Sous réserve des droits du Concédant sur l'Œuvre instrumentale préexistante, le Licencié dispose du droit exclusif d'exploiter chacune des Nouvelles Œuvres qu'il crée conformément à la présente Licence.
L'exclusivité accordée au Licencié ne constitue pas une cession de propriété de l'Œuvre instrumentale ni des droits d'auteur du Concédant sur celle-ci. Elle confère au Licencié l'exclusivité contractuelle des nouvelles exploitations autorisées à compter de la prise d'effet de la présente Licence.
Le Concédant ne pourra plus autoriser de nouveaux licenciés à créer ou exploiter une œuvre à partir de la même Œuvre instrumentale après la prise d'effet de la présente Licence Exclusive.
Le Licencié est autorisé à distribuer et exploiter chacune des Nouvelles Œuvres :
• en tant que single ;
• dans un EP ;
• dans un album ;
• dans une compilation ;
...
Dans le cadre de la Licence Exclusive, le Licencié est autorisé à exploiter chacune des Nouvelles Œuvres sans limitation quantitative, selon les conditions suivantes :
• nombre illimité d'écoutes sur les plateformes de streaming ;
• nombre illimité de vues vidéo monétisées et non-monétisées, ainsi que nombre illimité de clips musicaux et d'usages audiovisuels autorisés conformément à l'article 4.6 ;
• diffusion sans limitation quantitative sur les stations de radio ou de télévision ;
• performances publiques et concerts : {{performances_publiques}}.

Chaque Nouvelle Œuvre peut également être utilisée dans des contenus promotionnels directement destinés à promouvoir l'artiste ou la Nouvelle Œuvre concernée, notamment des extraits publiés sur les réseaux sociaux, sous réserve des dispositions audiovisuelles prévues à l'article 4.6.

4.5. Revenus générés par les Nouvelles Œuvres

Sous réserve du respect des termes de la présente Licence, le Licencié conserve les sommes qui lui sont versées au titre de l'exploitation commerciale et de la distribution de chacune des Nouvelles Œuvres.
Aucune redevance supplémentaire calculée sur les revenus de streaming, de vente ou de distribution des Nouvelles Œuvres n'est due au Concédant au titre de la présente Licence.
Cette stipulation est sans préjudice des droits d'auteur, droits voisins, droits mécaniques ou autres droits susceptibles d'être dus au Concédant conformément aux accords conclus entre les Parties et aux dispositions applicables.

4.6. Clip musical, synchronisation et illustration sonore

a. Clips musicaux des Nouvelles Œuvres
Le Licencié est autorisé à réaliser un nombre illimité de clips musicaux associés à chacune des Nouvelles Œuvres.
Le nombre de vues, monétisées ou non-monétisées, générées par ce clip musical n'est soumis à aucune limitation quantitative.
Aucune limitation quantitative ne s'applique au nombre de clips musicaux réalisés à partir des Nouvelles Œuvres.

b. Cinéma, films et documentaires
Le Licencié est autorisé à synchroniser l'Œuvre et/ou une ou plusieurs Nouvelles Œuvres, sans limitation quantitative du nombre de projets, dans des projets cinématographiques ou audiovisuels, notamment des films, courts-métrages, longs-métrages et documentaires.
Aucune nouvelle licence n'est requise pour chaque projet cinématographique, film, court-métrage, long-métrage, documentaire ou projet audiovisuel distinct couvert par la présente Licence Exclusive.

c. Publicité
Le Licencié est autorisé à utiliser et synchroniser l'Œuvre et/ou une ou plusieurs Nouvelles Œuvres dans un nombre illimité de contenus ou projets publicitaires.
Le nombre de contenus publicitaires distincts ainsi que leur nombre de diffusions, impressions ou vues ne sont soumis à aucune limitation quantitative au titre de la présente Licence Exclusive.

d. Vidéos en ligne, podcasts et illustration sonore
Le Licencié est autorisé à utiliser l'Œuvre instrumentale, sans création obligatoire d'une Nouvelle Œuvre, comme musique de fond ou illustration sonore dans un nombre illimité de vidéos YouTube, podcasts audio et contenus éditoriaux numériques similaires qu'il produit, publie ou exploite pour son propre compte.
Cette autorisation est limitée à un usage de l'Œuvre en fond sonore ou en illustration sonore. Elle ne permet pas de republier, distribuer, vendre ou mettre à disposition l'Œuvre comme contenu musical autonome, ni de transférer ou sous-licencier ce droit à un tiers.
Les utilisations relevant du cinéma, des films, des documentaires ou de la publicité sont autorisées dans les conditions prévues aux paragraphes b et c du présent article, sans limitation quantitative.
...
Le Concédant garantit que :
a. Il est titulaire ou, lorsqu'un ou plusieurs collaborateurs ont participé à la création de l'Œuvre, co-titulaire des droits patrimoniaux concernés, et dispose dans tous les cas de l'ensemble des droits, autorisations, accords ou mandats nécessaires pour accorder valablement la présente Licence Exclusive, consentir l'exclusivité prévue au Contrat et s'engager à ne plus accorder de nouvelles licences sur l'Œuvre après sa prise d'effet.
b. L'Œuvre est originale et ne contient aucun sample, extrait sonore ou élément soumis à des droits de tiers nécessitant une licence supplémentaire.
c. L'Œuvre ne contrevient à aucun droit de propriété intellectuelle et ne fait l'objet d'aucune réclamation ou litige en cours.
d. L'Œuvre est fournie « en l'état », sans garantie de compatibilité avec un système de distribution spécifique ni de performance commerciale sur les plateformes de streaming.
e. En cas de réclamation d'un tiers sur l'Œuvre, le Concédant s'engage à prendre en charge les frais de défense, à condition que le Licencié ait respecté toutes les clauses du présent contrat, et exclusivement si cette réclamation porte sur la composition instrumentale.
...
a. Le Licencié garantit que les éléments ajoutés par lui à la Nouvelle Œuvre ainsi que l'exploitation qu'il en fait ne sont pas illicites et ne portent pas atteinte aux droits de propriété intellectuelle, au droit à l'image, au droit à la dignité ou à tout autre droit du Concédant ou de tiers.
b. Le Licencié garantit le Concédant contre toute action, plainte, réclamation, contestation, revendication, litige ou demande d'indemnisation résultant d'une violation de la présente Licence imputable au Licencié ou d'un élément ajouté par celui-ci à une ou plusieurs Nouvelles Œuvres.
Les condamnations, dommages et intérêts, frais de justice et frais raisonnables de défense directement liés à une telle violation pourront être mis à la charge du Licencié dans les conditions prévues par la loi.

6. PROPRIÉTÉ, DROITS D'AUTEUR ET ÉDITION

Sous réserve des droits du Concédant sur l'Œuvre instrumentale sous-jacente et des droits des éventuels Collaborateurs, le Licencié est titulaire du master de chacune des Nouvelles Œuvres qu'il crée et peut exploiter chacun de ces masters conformément aux droits accordés par la présente Licence Exclusive.
La titularité des masters des Nouvelles Œuvres n'emporte aucune cession au Licencié de la propriété de l'Œuvre instrumentale, des droits d'auteur du Concédant ou des droits revenant aux éventuels Collaborateurs sur la composition sous-jacente.
Sauf accord écrit et signé contraire du Concédant, la répartition de base des droits d'auteur relatifs à la composition de chacune des Nouvelles Œuvres est fixée comme suit :
...
De la même manière, l'existence d'un éditeur représentant le Licencié ne pourra en aucun cas avoir pour effet de désigner cet éditeur comme éditeur du Concédant.
Lorsque le Concédant ne dispose pas d'un éditeur tiers pour sa propre quote-part éditoriale, celle-ci demeure sous son contrôle. Il pourra notamment être déclaré en qualité d'éditeur à compte d'auteur (EACA) auprès de la SACEM ou sous toute forme équivalente reconnue par une autre société de gestion collective de droits d'auteur.
Tout dépôt ou toute déclaration d'une Nouvelle Œuvre auprès d'une société de perception et de répartition des droits devra faire l'objet d'une négociation directe entre les Parties et d'un accord écrit conformément aux dispositions du présent Contrat.

7. RESTRICTIONS ET INTERDICTIONS

a. Sociétés de gestion collective
Il est interdit d'enregistrer ou de faire enregistrer l'Œuvre et/ou une ou plusieurs Nouvelles Œuvres auprès d'une société de gestion collective ou organisme équivalent, notamment la SACEM, BMI, ASCAP, GEMA, SIAE, PRS for Music, SOCAN, ou toute autre société exerçant une fonction comparable dans quelque territoire que ce soit, sans l'accord préalable écrit et signé du Concédant.
Toute déclaration autorisée devra impérativement respecter la répartition des droits prévue à l'article 6 ou toute répartition différente expressément acceptée par écrit et signée par le Concédant.
Toute déclaration effectuée en violation du présent article constitue un manquement contractuel susceptible d'entraîner l'application des mesures prévues à l'article 9.

b. Content ID et systèmes d'identification automatique
Le Licencié est autorisé, dans le cadre de la présente Licence Exclusive, à enregistrer une ou plusieurs Nouvelles Œuvres et/ou leurs masters dans un système de reconnaissance automatique ou de Content ID, notamment YouTube Content ID, afin de détecter les contenus utilisant tout ou partie de l'Œuvre et, lorsque le système le permet, d'en réclamer automatiquement la monétisation.
Cette autorisation s'exerce sous réserve du respect des licences antérieures visées à l'article 4.1.
Le Licencié s'interdit d'utiliser le Content ID afin de faire supprimer, bloquer ou maintenir démonétisé un contenu exploité conformément à une licence antérieure valide portant sur la même Œuvre.
Lorsqu'un titulaire d'une licence antérieure conteste une réclamation Content ID et justifie d'une licence valable couvrant son utilisation de l'Œuvre, le Licencié devra abandonner, retirer ou faire lever dans les meilleurs délais la réclamation concernée dans la mesure nécessaire au respect des droits de ce licencié antérieur.
Le Licencié demeure responsable des démarches entreprises par les distributeurs, labels, agrégateurs ou autres prestataires qu'il mandate pour gérer le Content ID et devra leur transmettre les instructions nécessaires au respect de l'article 4.1.
...
• revendre la présente Licence ;
• sous-licencier l'Œuvre à un tiers ;
• permettre à un tiers d'utiliser l'Œuvre pour créer une œuvre distincte des Nouvelles Œuvres créées ou exploitées par le Licencié dans le cadre de la présente Licence.
La transmission des fichiers aux personnes participant directement à la création technique ou artistique des Nouvelles Œuvres demeure toutefois autorisée conformément à l'article 3.
...
a. Droit à la paternité de l'Œuvre
Le Licencié s'engage à identifier le Concédant comme compositeur et/ou producteur de l'Œuvre au moyen du crédit « Produced by {{credit_concedant}} » ou de toute mention équivalente, dès lors que celle-ci permet d'identifier explicitement le rôle du Concédant et, le cas échéant, de ses éventuels collaborateurs en qualité de compositeur(s), co-compositeur(s), producteur(s) ou co-producteur(s) de l'Œuvre.
Ce crédit ou toute mention équivalente devra être mentionné, lorsque le support concerné permet techniquement son affichage, sur les plateformes et supports utilisés pour l'exploitation des Nouvelles Œuvres, notamment les métadonnées des plateformes de streaming, descriptions de vidéos, crédits d'album, supports physiques et autres espaces destinés à l'identification des contributeurs.
En cas d'oubli, d'erreur ou d'absence de crédit, le Licencié devra régulariser la situation dans le délai qui lui sera communiqué par le Concédant dans la notification du manquement.
Le non-respect de cette obligation après expiration du délai de régularisation constitue un manquement contractuel susceptible d'entraîner l'application des mesures prévues à l'article 9.
...
• d'absence ou d'erreur concernant le crédit du Concédant ;
• de déclaration non autorisée ou incorrecte auprès d'une société de gestion collective ;
• d'utilisation du Content ID en violation des droits d'un licencié antérieur ou des obligations prévues à l'article 7.b ;
• ou de tout autre manquement pouvant raisonnablement être corrigé,
le Concédant pourra notifier le Licencié par écrit en indiquant la nature du manquement et le délai accordé pour le régulariser.
Ce délai sera déterminé par le Concédant en fonction de la nature du manquement et des démarches nécessaires à sa correction.
Si le Licencié régularise intégralement la situation dans le délai indiqué, le Concédant pourra maintenir la Licence en vigueur.
À défaut de régularisation dans le délai imparti, le Concédant pourra suspendre ou résilier la Licence ainsi que les droits d'exploitation qui en découlent.
Le Concédant pourra alors entreprendre les démarches nécessaires afin de faire suspendre ou retirer l'exploitation de la ou des Nouvelles Œuvres concernées, notamment au moyen d'une réclamation fondée sur les droits qu'il détient sur l'Œuvre.

9.2. Respect des licences antérieures et utilisation du Content ID

Le non-respect des droits attachés aux licences antérieures visées à l'article 4.1 constitue un manquement au présent Contrat.
Les obligations particulières applicables au Content ID sont précisées à l'article 7.b.
...
La présente Licence Exclusive est concédée pour le monde entier et pour toute la durée légale de protection des droits concernés, sans limitation contractuelle de durée.
Aucun renouvellement périodique de la présente Licence Exclusive n'est requis pour poursuivre l'exploitation autorisée pendant la durée légale de protection des droits concernés.
La présente durée n'emporte aucune cession de propriété supplémentaire au Licencié sur l'Œuvre instrumentale ni sur les droits d'auteur du Concédant, au-delà des droits expressément accordés par le présent Contrat.

12. CONFIDENTIALITÉ

Les termes et conditions de la présente Licence sont confidentiels et ne peuvent être divulgués à des tiers sans l'accord écrit du Concédant, sauf lorsque cette communication est nécessaire :
• à l'exécution ou à la distribution d'une ou plusieurs Nouvelles Œuvres ;
• à un avocat, conseil juridique, comptable, manager ou représentant professionnel du Licencié ;
• à un label, distributeur ou partenaire professionnel ayant besoin de connaître l'existence ou les conditions de la Licence ;
• à une société de gestion collective dans le cadre d'une démarche autorisée par le Concédant ;
• en application d'une obligation légale ou d'une demande d'une autorité compétente.
