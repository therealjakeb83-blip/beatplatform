...
| `acheteur_raison_sociale` | text | Raison sociale saisie au checkout professionnel, figée sur cette commande uniquement; affichée sur la facture et le détail de commande |
| `acheteur_numero_tva` | text | Numéro de TVA saisi au checkout professionnel, figé sur cette commande uniquement; non recopié dans le CRM client |
